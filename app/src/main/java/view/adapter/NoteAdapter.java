...
public class NoteAdapter extends RecyclerView.Adapter {
    ...
    @Override
    public NoteAdapter.CourseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = mInflater.inflate(R.layout.content_notedetail, parent, false);
        return new NoteAdapter.CourseViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        NoteAdapter.CourseViewHolder holder1 = (NoteAdapter.CourseViewHolder) holder;
